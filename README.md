...
- admin com cadastro unico de alunos pela Secretaria e identidade vinculada 1:1 entre AVA, Financeiro e Agenda em todos os caminhos de criacao, historico de registros antigos, redefinicao de senha, status ativo/inativo, vinculo aluno-teacher, contratos, manutencao, cofre de APIs/senhas, card Admin XP persistente e modulo Candy XP para criar historias/atividades com PDF do Canva e areas interativas sobre o arquivo;
...
- teacher com selecao de qualquer aluno ativo no AVA e no PDV, acompanhamento mensal sem valores, venda de produtos discriminada na mensalidade aberta do aluno (mes atual ou proximo, se o atual estiver fechado), fatura somente de produtos quando nao existe mensalidade no mes atual, conta pessoal para compras marcadas com indicador de fatura pendente no perfil e acesso aos registros antigos proprios/atribuidos da Secretaria, aulas interativas por upload do Canva, materiais, vocabulario, homework interativo, feedback, area de aula ao vivo em manutencao temporaria, contratos, mensagens e card Teacher XP persistente;
...
- `docs/11-seguranca.md`: defesa em camadas, monitoramento, CI, dependencias e controles externos.
