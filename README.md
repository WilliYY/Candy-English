...
- escolha pos-login limpa para `ADMIN` e `TEACHER`, separando `AVA`, `Secretaria` e `Financeiro` antes de carregar a sidebar de trabalho; o Financeiro da Teacher mostra apenas situacao mensal de todos os alunos ativos, sem valores; `STUDENT` entra direto no AVA Student;
