...
- API mobile ADMIN para listar, buscar, filtrar, paginar, detalhar, criar, editar e ativar/desativar usuarios, protegida pela role autenticada, confirmacao de status, concorrencia segura e sem expor senha, versao de sessao ou caminhos internos;
