...
- `CATTY_ARTIFACT_ENRICHMENT_ENABLED`: ativa/desativa enriquecimento de temas no painel Admin/Teacher `Catty Learning: gostos`; nao afeta o chat normal.
