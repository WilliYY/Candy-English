...
- Catty como mascote publica com baloes aleatorios no site e assistente interna do AVA para usuarios logados, com Gemini padrao, OpenAI apenas quando a mensagem chama Catty pelo nome, fallback local autorizado, historico recente persistente e limitado, atalhos de estudo, baloes personalizados, incentivo e pratica simples em ingles;
