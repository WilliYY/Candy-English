...
- campos Listening no homework/aula interativa, com botao de volume posicionado no fim da area desenhada, audio OpenAI text-to-speech em ingles e alternancia normal/devagar a cada clique;
...
- `OPENAI_API_KEY`: chave opcional usada pela Catty somente quando a mensagem chama Catty pelo nome, pelo OCR opcional de homework e pelo audio OpenAI dos campos Listening; sem chave, Catty cai para Gemini/fallback e Listening fica indisponivel.
