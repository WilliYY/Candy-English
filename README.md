...
- API mobile ADMIN para consultar o resumo financeiro mensal por unidade, com recebido, pendente, atrasado, cadastros incompletos, busca e paginacao, sem executar cobranca e sem expor CPF ou endereco no painel movel;
