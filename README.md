...
- API mobile ADMIN para consultar todos os pre-cadastros com busca, filtro por etapa/unidade, paginacao e detalhe administrativo completo, protegida pela role autenticada e sem expor identificadores internos de conversao;
