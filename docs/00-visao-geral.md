...
- Catty responde apenas para usuarios autenticados do AVA; usa Gemini pelo servidor como provedor padrao, OpenAI apenas quando a mensagem chama Catty pelo nome, e fallback local autorizado quando as chaves/chamadas falham.
