...
- Catty usa Gemini pelo servidor como provedor padrao, OpenAI apenas quando a mensagem chama Catty pelo nome, e fallback local quando as chaves/chamadas falham.
