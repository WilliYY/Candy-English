...
- Catty e interface visual com IA opcional via Gemini quando `GEMINI_API_KEY` existe, OpenAI apenas quando a mensagem chama Catty pelo nome e fallback local quando as chaves/chamadas falham.
