...
- O shell lateral do AVA fica em `AvaWorkspaceShell` e recebe o modo atual (`AVA`, `SECRETARIA` ou `STUDENT`) pelas paginas protegidas, evitando buscar dados de sidebar em `/ava/escolha`.
