...
- Home atual usa `public/brand/home-candy-2.mp4` como video principal do hero em loop mudo, dentro do primeiro card dominante, com encaixe sem corte e fundo branco quando sobra area.
- No hero da home, `intro-1.mp4` e `intro-2.mp4` aparecem como cards de apoio, com borda suave, autoplay mudo, loop, fundo branco para evitar cortes e botoes visiveis para pausar/retomar e ligar/desligar som.
