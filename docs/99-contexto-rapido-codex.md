...
- Admin gerencia usuarios, cria/acompanha/converte pre-cadastros, edita nome/email/telefone principal de alunos pela tela `Usuarios` com action `ADMIN` server-side, redefinicao de senha, vinculos, contratos, financeiro, agenda, manutencao e cofre de APIs/senhas.
