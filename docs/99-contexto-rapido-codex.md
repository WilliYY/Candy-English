...
- Pre-cadastros sao criados manualmente dentro da Secretaria depois do contato pelo WhatsApp; Admin ve todos, Teacher ve apenas criados por ela ou atribuidos a ela, e o registro salva unidade, teacher responsavel, agenda pretendida e combinado de pagamento sem criar financeiro/agenda/login ate `Tornar aluno`.
...
- Teacher cria aulas, homework interativo, materiais, feedback, mensagens, contratos, ve a aula ao vivo em manutencao temporaria e pode criar/acompanhar/converter seus pre-cadastros como alunos `STUDENT` vinculados a sua teacher.
