...
- Pre-cadastros sao criados manualmente dentro da Secretaria depois do contato pelo WhatsApp; Admin ve todos, Teacher ve apenas criados por ela ou atribuidos a ela, e a busca do painel roda no client apenas sobre essa lista autorizada, normalizando acentos e telefone/documento por digitos. O registro salva unidade, teacher responsavel, agenda pretendida e combinado de pagamento. No clique confirmado em `Tornar aluno`, uma transaction cria User STUDENT, StudentProfile, vinculo teacher quando aplicavel, financeiro e agenda, salvando os ids linkados no pre-cadastro.
