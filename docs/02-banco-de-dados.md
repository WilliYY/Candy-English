...
- Enriquecimento de artefato nunca e usado no chat normal antes de aprovacao humana. Admin/Teacher podem pedir sugestao no painel `Catty Learning: gostos`; Student nao aciona enriquecimento, aprovacao ou configuracao de artefato.
