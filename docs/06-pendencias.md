...
- Jogos executaveis; hoje existem cards/roadmaps Candy XP persistentes nos paineis admin, teacher e student, com catalogo base de missoes, mas sem tela/jogo jogavel.
