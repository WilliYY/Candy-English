...
- A posicao pessoal do ranking no mini card de perfil/XP deve ser um badge compacto dentro da area amarela do Candy XP, com medalha, `#posicao`, categoria, XP total e XP restante; em 0 XP, usar chamada curta para comecar uma missao sem reservar espaco quebrado.
