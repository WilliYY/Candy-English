...
- hero da home com video local leve `public/brand/home-candy.mp4` em loop, muted/autoplay, palco amplo e dois videos de intro encaixados nos espacos do mockup; os videos preenchem as janelas dos cards com recorte controlado, e os controles desenhados no mockup recebem camada visual de botao para play/stop/volume, com os videos pausados por padrao para evitar custo inicial alto;
...
- O hero da home usa `public/brand/home-candy.mp4` como palco em loop leve e mais largo no viewport; `public/brand/intro-1.mp4` e `public/brand/intro-2.mp4` ficam encaixados nas janelas dos cards do mockup, em `object-cover` com recorte controlado e com botoes translucidos sobre os comandos desenhados de play/stop/volume, sem autoplay nem loop. O video local `public/brand/home.mp4` continua no bloco final de contato como apoio visual leve, com o footer entrando por cima do modulo por animacao gooey, sem degrade de transicao antes do rodape.
