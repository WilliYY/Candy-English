...
- Admin deve poder alternar a base de usuarios entre `Planilha` e `Cartoes`, abrindo por padrao na planilha operacional. A planilha ordena admins, teachers e alunos, exibe usuario, role, status, contato, perfil, sinal e data em colunas e abre cada linha para manter edicao de contato e acoes de acesso; no celular, preserva largura legivel com rolagem horizontal. A visualizacao em cartoes continua separada por role para reduzir confusao visual, com cores distintas (admin amber, teacher pink e aluno sky), barra de saude da role, indicadores uteis, historico e sinais de pendencia em areas recolhidas.
