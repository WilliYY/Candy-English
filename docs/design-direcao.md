...
- O hero da home usa `public/brand/home-candy-2.mp4` como fundo em loop leve do primeiro card, com `object-contain`, palco menos horizontal e zoom leve para reduzir a borda branca sem cortar agressivamente o layout gravado. `public/brand/intro-1.mp4` e `public/brand/intro-2.mp4` ficam dentro desse mesmo card como videos embutidos, nao em coluna externa, com borda roxa suave, autoplay mudo, loop e controles visiveis de pausa/play e som. O video local `public/brand/home.mp4` continua no bloco final de contato como apoio visual leve, com o footer entrando por cima do modulo por animacao gooey, sem degrade de transicao antes do rodape.
