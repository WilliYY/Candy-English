...
- O resumo student pode usar Candy XP como superficie de gamificacao: bordas de 8px, roxo/rosa da marca, barra amarela de progresso com brilho suave, fontes de XP bem escaneaveis e slot `Jogos Candy` sem prometer jogo executavel antes da fase propria.
