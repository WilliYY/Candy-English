...
- Perfil interno do AVA usa cards suaves com fundo glass claro, hierarquia por icones, painel de completude student com barra amarela/roxa, marcos visuais verdes conforme campos sao preenchidos e recompensa de ate 350 XP dividida entre dados principais (150 XP) e aluno/responsavel (200 XP), resumo superior de campos/XP, formulario separado por dados principais e dados do aluno, alem de foto em lateral com borda/ring discreto para dar acabamento sem perder leitura operacional.
