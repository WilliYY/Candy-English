...
- Na planilha de usuarios, nome completo, email, telefone, polo, perfil e sinais devem quebrar linha em vez de usar reticencias; a acao da linha fica fixa a direita durante a rolagem e o detalhe aberto repete a identificacao completa e o historico em itens. `Excluir conta` usa bloco vermelho recolhido, explica a retencao de 2 anos e exige motivo + confirmacao `EXCLUIR` antes da acao destrutiva.
