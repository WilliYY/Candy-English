...
- A tela de pre-cadastros da Secretaria deve parecer controle interno, nao landing page: formulario manual no topo, filtros por status, cards escaneaveis com unidade, contato, teacher responsavel, agenda pretendida e combinado de pagamento; conversao para `STUDENT` fica em acao separada e deve lembrar que financeiro/agenda nao sao criados automaticamente.
