...
- A tarefa admin `Vincular aluno` deve mostrar o relacionamento como mapa teacher -> aluno: formulario com previa do vinculo selecionado, cards agrupados por teacher e linhas de alunos com email/data para deixar claro quem aparece para quem.
