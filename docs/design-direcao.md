...
- Em telas menores que tablet (`<768px`), os baloes automaticos da Catty devem ser discretos: mostrar no maximo 3 falas por rota, manter a terceira por poucos segundos e esconder o balao, deixando apenas o botao/mascote. Em tablet e desktop, a troca continua a cada 10 segundos.
