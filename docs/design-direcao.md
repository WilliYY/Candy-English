...
- Os paineis admin, teacher e student podem usar Candy XP como superficie de gamificacao: bordas de 8px, roxo/rosa da marca, barra amarela de progresso com brilho suave, trilha de niveis infinita, fontes de XP bem escaneaveis e slot de spotlight sem prometer jogo executavel antes da fase propria.
