...
- O `Ranking Candy XP` interno deve parecer gamificado e legivel: top 3 com destaque visual, lista compacta para as demais posicoes, foto/avatar ou iniciais, `Prof` para teachers, selo `voce` quando for o usuario logado, metricas de XP/XP restante e nenhum email ou dado sensivel.
