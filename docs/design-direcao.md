...
- Catty deve parecer mais viva sem dominar a tela: botao com avatar maior, chat aberto com cabecalho compacto, sem texto explicativo longo ou chips decorativos sem acao, estado de digitacao, atalhos de estudo funcionais em faixa curta acima do input, adaptados a homework, aulas, mensagens, teacher ou admin, e baloes visuais locais para usuarios logados no AVA com primeiro nome e saudacao por horario. O chat aberto deve usar grade com linha central flexivel, texto quebrando linha e avatar com `object-contain` para nao cortar fala, atalhos ou imagem da mascote. Fora do AVA logado, a Catty aparece como mascote publica com baloes aleatorios a cada 10 segundos, posicionada acima do WhatsApp quando ele existir, e no clique mostra apenas um aviso pequeno para entrar no AVA ou virar aluno Candy antes de conversa real. Os baloes visuais nao devem capturar clique, para nao bloquear login, tarefas ou botoes proximos.
