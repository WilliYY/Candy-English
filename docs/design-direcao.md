...
- O financeiro admin deve ser intuitivo e escaneavel: ao abrir, mostrar a alternancia compacta entre `Alunos e mensalidades` e `Gastos da loja`; a aba de alunos usa uma planilha mensal agrupada por polo, com Ivaté em verde primeiro e Douradina em azul depois, colunas de aluno, mes, mensalidade, vencimento, situacao e acao, linhas pagas verdes e linhas em aberto amarelas. O detalhe e historico do aluno so aparece depois de clicar na linha, para a planilha usar toda a largura inicialmente. A navegacao de competencia fica no topo com setas e seletor de mes, e o cadastro de nova mensalidade permanece recolhido. A aba `Gastos da loja` deve parecer controle interno independente, com resumo proprio de gastos/insumos e sem totais de alunos, recebidos ou pendentes; manter filtros de unidade, formulario de insumos/gastos, lista compacta e log, com campos de borda/foco visiveis e responsividade sem parecer gateway de pagamento.
