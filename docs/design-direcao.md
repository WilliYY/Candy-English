...
- hero da home com video local leve `public/brand/home-candy-2.mp4` em loop, muted/autoplay, palco amplo e dois videos de intro em cards lado a lado; os videos de intro tambem iniciam em loop mudo, com botoes visiveis para pausar/retomar e ligar/desligar som;
