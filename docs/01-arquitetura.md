...
- O prompt da Catty mescla historico persistido com historico local recente do widget, remove a mensagem atual duplicada, limita a 8 mensagens e cai para fallback por intencao quando a IA retorna vazio, cortado, generico, fora de tom ou inseguro para homework/pedido de resposta pronta/assunto fora do escopo; o plano diferencia correcao, traducao, explicacao, pedido de resposta pronta, redirecionamento para estudo de ingles, motivacao, pergunta confusa e pergunta longa/misturada.
