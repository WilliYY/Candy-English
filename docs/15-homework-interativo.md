...
- A tela `Aulas` mantem a mesma base tecnica, mas mostra resumo proprio de aulas, areas e alunos, formulario organizado em participantes, detalhes e material, acentos visuais por etapa e cards de `Aula interativa` separados visualmente dos cards de homework.
