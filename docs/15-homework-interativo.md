...
- Campos `TINY_TEXT` aparecem para o aluno como caixinha pequena vazia, centralizada, aceitam ate 2 caracteres e normalizam letras/numeros para maiusculas tambem no servidor antes de salvar; no editor, a teacher ve apenas um preview `A`/badge compacto para posicionamento sem sugerir resposta ao aluno.
