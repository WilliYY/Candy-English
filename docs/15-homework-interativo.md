...
- A tela `Criar/Ver Homework` mantem a criacao em blocos visuais separados para selecao/dados, instrucoes/upload e fila de criacao; o seletor de alunos fica minimizado por padrao com resumo dos selecionados e opcao de abrir a lista ou marcar todos. Quando todos estao marcados, o resumo mostra uma frase curta com o total, sem comprimir o checkbox nem empilhar todos os nomes, e oferece `Limpar` como acao separada; a lista mostra atividade, aluno, aula, arquivo, status de salvamento e quantidade de areas em cards mais escaneaveis antes de abrir o editor, com cores distintas para item, aula, arquivo, replicacao e pronto/salvo.
