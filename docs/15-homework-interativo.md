...
- A teacher pode usar a ferramenta `Listening` para desenhar uma area sobre um trecho do PDF/imagem com uma ou mais frases; ao criar ou reler o box, o servidor tenta ler automaticamente o texto dentro da area com OpenAI, preenche o texto do listening para conferencia manual e deixa o icone de volume automaticamente no fim direito do box.
