      ...
      <div className="grid items-start gap-5 xl:grid-cols-[minmax(0,1fr)_390px]">
        ...
        <aside className="overflow-hidden rounded-lg border border-primary/18 bg-white shadow-[0_22px_54px_rgba(65,42,76,0.12)] xl:sticky xl:top-5">
          ...
          <div className="grid gap-3 border-t border-primary/10 p-4">
            <div className="flex items-center justify-between gap-3"><span className="text-sm font-bold text-primary">Total</span><strong className="text-2xl tabular-nums text-primary">{formatCurrency(cartTotal)}</strong></div>
