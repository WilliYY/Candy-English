...
export const CATTY_SCENARIOS: CattyScenario[] = [
  ...
  },
  {
    ...
    idealReply:
      "Miauw 😺 Water means a clear liquid people drink. Example: I drink water every day. Your turn: make one sentence with water.",
  ...
  },
  {
    ...
    category: "vocabulary",
    context: { area: "student", task: "resumo" },
    id: "advanced-meaning-water-what-does",
    idealReply:
      "Miauw 😺 Water means a clear liquid people drink. Example: I drink water every day. Your turn: make one sentence with water.",
    intent: "advanced_word_meaning",
    name: "Meaning avancado - what does",
    rule: "A forma what does ... mean ativa a explicacao em ingles quando a mensagem chama a Catty.",
    tags: ["advanced-meaning", "water", "what-does", "vocabulary"],
    userInput: "Catty, what does water mean?",
  },
  {
    badReply: "Water significa agua.",
    category: "vocabulary",
    context: { area: "student", task: "resumo" },
    id: "advanced-meaning-water-meaning-of",
    idealReply:
      "Miauw 😺 Water means a clear liquid people drink. Example: I drink water every day. Your turn: make one sentence with water.",
    intent: "advanced_word_meaning",
    name: "Meaning avancado - meaning of",
    rule: "A forma meaning of recebe a mesma definicao curta, exemplo e convite de pratica.",
    tags: ["advanced-meaning", "water", "meaning-of", "vocabulary"],
    userInput: "Catty, meaning of water",
  },
  {
    badReply: "Look after significa cuidar.",
    category: "vocabulary",
    context: { area: "student", task: "resumo" },
    id: "advanced-meaning-look-after",
    idealReply:
      "Pss pss 🐾 Look after means to take care of someone or something. Example: I look after my dog. Your turn: who do you look after?",
    intent: "advanced_word_meaning",
    name: "Meaning avancado - look after",
    rule: "Phrasal verb comum e explicado como uma unica expressao e mantem o tema na pergunta.",
    tags: ["advanced-meaning", "look-after", "phrasal-verb", "vocabulary"],
    userInput: "Catty, look after meaning",
  },
  {
    badReply: "Take care significa cuidar.",
    category: "vocabulary",
    context: { area: "student", task: "resumo" },
    id: "advanced-meaning-take-care",
    idealReply:
      "Miauw 😺 Take care means to keep someone or something safe and well. Example: I take care of my little brother. Your turn: who do you take care of?",
    intent: "advanced_word_meaning",
    name: "Meaning avancado - take care",
    rule: "Expressao curta recebe o sentido cotidiano mais comum sem virar lista de traducoes.",
    tags: ["advanced-meaning", "take-care", "expression", "vocabulary"],
    userInput: "Catty, take care meaning",
  },
  {
    badReply: "How are you significa como voce esta.",
    category: "vocabulary",
    context: { area: "student", task: "resumo" },
    id: "advanced-meaning-how-are-you",
    idealReply:
      "Miauw 😺 How are you means a common question used to ask how someone feels. Example: Hi, Anna. How are you? Your turn: answer the question How are you?",
    intent: "advanced_word_meaning",
    name: "Meaning avancado - how are you",
    rule: "Uma frase curta pode ser o alvo completo e recebe explicacao funcional em ingles.",
    tags: ["advanced-meaning", "how-are-you", "expression", "vocabulary"],
    userInput: "Catty, how are you meaning",
  },
  {
    badReply: "I'm into games significa eu gosto de jogos.",
    category: "vocabulary",
    context: { area: "student", task: "resumo" },
    id: "advanced-meaning-into-games",
    idealReply:
      "Awnn, good phrase 🎮 I'm into games means I like games a lot. Example: I'm into games and music. Your turn: what are you into?",
    intent: "advanced_word_meaning",
    name: "Meaning avancado - be into",
    rule: "A forma conjugada de be into e reconhecida e explicada com o interesse informado pelo aluno.",
    tags: ["advanced-meaning", "be-into", "games", "expression"],
    userInput: "Catty, I'm into games meaning",
  },
  {
    badReply: "Mall significa shopping.",
    category: "vocabulary",
    context: { area: "student", task: "resumo" },
    id: "advanced-meaning-explain-mall",
    idealReply:
      "Miauw 😺 Mall means a large building with many stores. Example: We go to the mall on Saturday. Your turn: make one sentence with mall.",
    intent: "advanced_word_meaning",
    name: "Meaning avancado - explain the meaning of",
    rule: "A forma explain the meaning of ativa o mesmo contrato de definicao, exemplo e pratica.",
    tags: ["advanced-meaning", "mall", "explain", "vocabulary"],
    userInput: "Catty, explain the meaning of mall",
  },
  {
    badReply: "Aqui esta uma definicao longa para todo o texto.",
    category: "vocabulary",
    context: { area: "student", task: "resumo" },
    id: "advanced-meaning-over-limit",
    idealReply:
      "Miauw 😺 That target is too long. Send one word or a shorter expression with up to 15 words.",
    intent: "advanced_word_meaning",
    name: "Meaning avancado - acima do limite",
    rule: "Alvo com mais de 15 palavras nao e definido; a Catty pede uma palavra ou expressao menor.",
    tags: ["advanced-meaning", "limit", "safety", "vocabulary"],
    userInput:
      "Catty, this phrase has way too many separate words for one clear vocabulary target in a short meaning command today please meaning",
  },
  {
    ...
    idealReply:
      "Uwau ✨ Beautiful means very pretty or nice to see. Example: The flower is beautiful. Your turn: make one sentence with beautiful.",
    intent: "advanced_word_meaning",
  ...
  },
  {
    ...
    idealReply:
      "Miauw 😺 Homework means school work that a student does outside class. Example: I do my homework after dinner. Your turn: make one sentence with homework.",
    intent: "advanced_word_meaning",
  ...
  },
  {
    ...
    idealReply:
      "Miauw 😺 Run means to move fast with your legs. Example: I run in the park. Your turn: can you use run?",
    intent: "advanced_word_meaning",
