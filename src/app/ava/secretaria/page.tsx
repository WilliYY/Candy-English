...
const teacherCards = [
  {
    description: "Revise interessados e aceite alunos vinculados a sua teacher.",
  ...
  {
    description: "Envie e visualize contratos PDF dos alunos permitidos.",
...
export default async function SecretariaPage() {
  ...
  const cards = session.user.role === "ADMIN" ? adminCards : teacherCards;
