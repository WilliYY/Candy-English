...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <section className="relative isolate overflow-hidden bg-[#fef7f3] pb-28">
        <video
        ...
        <div className="absolute inset-x-0 bottom-0 z-[2] h-44 bg-gradient-to-b from-transparent via-[#fef7f3]/70 to-[#412a4c]" />
        <div className="absolute inset-x-0 top-0 z-[2] h-px bg-gradient-to-r from-transparent via-primary/20 to-transparent" />
